                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                        action="" method="POST">
                                                        <button type="button" class="btn btn-sm btn-outline-info" data-id="">
                                                            <i class="fe fe-info"></i>
                                                        </button>
                                                        <a href=""
                                                            class="btn btn-sm btn-outline-warning"><i class="fe fe-edit"></i>
                                                        </a>
                                                        {{-- @csrf
                                                        @method('DELETE') --}}
                                                        <button type="submit" class="btn btn-sm btn-outline-danger"><i class="fe fe-trash"></i></button>
                                                    </form>
                                            </tr>
                                        </tbody>
                                    </table>
