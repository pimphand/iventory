    ...
    const table = new DataTable('unloading', "{{ route('api.unloading.index') }}", [{
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    ...
                    return '<button class="btn btn-sm btn-primary btn-edit mr-2" data-data=' + rowData + '>Edit</button><button class="btn btn-sm btn-danger ml-2 btn-delete">Hapus</button>';
                }
            },
        ]);
